...
namespace Assignment2.Data.Migrations
{
    ...
    [Migration("20180518120854_confirm")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Assignment2.Models.Cart", b =>
                {
                    ...
                    b.HasKey("CustomerID", "StoreID", "ProductID");
            ...
            modelBuilder.Entity("Assignment2.Models.OrderHistory", b =>
                {
                    ...
                    b.HasIndex("OrderID1", "OrderProductID", "OrderStoreID")
                        .IsUnique()
                        .HasFilter("[OrderID1] IS NOT NULL AND [OrderProductID] IS NOT NULL AND [OrderStoreID] IS NOT NULL");
            ...
            modelBuilder.Entity("Assignment2.Models.OrderHistory", b =>
                {
                    b.HasOne("Assignment2.Models.Order")
                        .WithOne("Orders")
                        .HasForeignKey("Assignment2.Models.OrderHistory", "OrderID1", "OrderProductID", "OrderStoreID");
                });
